...
No Linux/Ubuntu, os comandos equivalentes são:

```bash
sudo apt update
sudo apt install default-jdk

wget https://repo1.maven.org/maven2/net/java/dev/javacc/javacc/7.0.10/javacc-7.0.10.jar -O javacc.jar
